...
export default function WildGuardChat() {
  ...
  // Re-localize slogan + scenarios when language changes, and start a new chat
  useEffect(() => {
        ...
        <main className="flex-1 flex flex-col min-w-0 bg-[#f4f1e8]">
          ...
          <header className="px-4 sm:px-8 pt-4 sm:pt-5 pb-3 flex items-start gap-3 flex-wrap">
            ...
            <div className="flex items-center gap-2 flex-wrap justify-end">
              {/* Past Chats button — only shown when signed in */}
              {user && <div className="relative" onClick={(e) => e.stopPropagation()}>
